...
namespace DCCS.Areas.Identity.Pages.Account
{
    ...
    {
        private readonly static Lazy<Tunnel> NgrokTunnel = new Lazy<Tunnel>(
            () =>
            {
                NgrokClient client = new NgrokClient();
                return client.GetFirstHttpsTunnel();
            });
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new DCCSUser { UserName = Input.Email, Email = Input.Email };
...
#if DEBUG
                    Tunnel tunnel = NgrokTunnel.Value;
                    callbackUrl = callbackUrl.Replace(
                        tunnel.Configuration.Address,
                        tunnel.PublicUrl);
#endif
